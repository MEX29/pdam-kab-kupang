            ...
            <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
              <nav class="navigation navbar navbar-expand-md navbar-dark ">
                ...
                <div class="collapse navbar-collapse" id="navbarsExample04">
                  <div class="sign_btn">
                    <a style="cursor: pointer;" onclick="window.location.href='auth/';" class="d-flex btn btn-primary border-0 rounded-0 shadow-lg text-white">
                      <ion-icon name="log-in-outline" class="my-auto" style="font-size: 20px;"></ion-icon>
                      <p class="ml-1">Masuk</p>
                    </a>
                  </div>
                </div>
              </nav>
            ...
            <div class="row d_flex">
              <div class="col-xl-6 col-lg-6 col-md-12 padding_right1">
                <div class="text_box_color">
                  <div class="text-bg">
                    <h1 style="font-family: 'Montserrat', sans-serif;font-weight: 700;">PDAM</h1>
                    <strong style="font-family: 'Montserrat', sans-serif;">Kabupaten Kupang</strong>
                    <p class="mt-3 text-white">Pengangkatan pegawai tidak tetap menjadi pegawai tetap dengan menggunakan Metode SMART (Simple Multi Attribute Rating Technique) dalam upaya untuk mendapatkan keputusan yang tepat dan akurat sesuai kriteria pada PDAM Kabupaten Kupang.</p>
                  </div>
                </div>
              </div>
              <div class="col-xl-6 col-lg-6 col-md-12 padding_right1">
                <div class="text-img">
                  <figure><img src="assets/images/banner.jpg" alt="#" /></figure>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <small>© <?= date('Y') ?> All Rights Reserved. Powered by <a href="https://www.netmedia-framecode.com/"> Netmedia Framecode</a></small>
          </div>
        </div>
      </div>
    </div>
